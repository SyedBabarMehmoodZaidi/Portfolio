  ...
  return (
    ...
    <div className='grid md:grid-cols-2 gap-10'>
     <div className='space-y-8'>
        ...
        <div className='flex gap-3 items-center'data-aos="zoom-in-up"><TbMail size={30}/>xyz@gmail.com </div>
        
        <div className='flex gap-3 items-center'data-aos="zoom-in-up"><BsTelephone size={30}/>(0900)-78601 </div>
        </div>   
       <div className='space-y-8'>
        ...
        <button className='bg-accent p-2 px-6 rounded-full ...'data-aos="zoom-in-up">Send</button>
       </div>
    </div>    
    </div>
  )
